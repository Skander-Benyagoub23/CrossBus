...
if(isset($_POST["submitpro"])){
    ...
    $stmt = $connection->prepare("INSERT INTO propriétaire (nom_prop , prenom_prop , contact_prop , email_prop , nom_entreprise , id_utilisateur) VALUES ('$nom_prop','$prenom_prop','$contact_prop'
     ,'$email_prop','$nom_entreprise','$util')");
    $stmt->execute();
    $nom_prop = "";
    $prenom_prop = "";
    $contact_prop = "";
...
<input type='text' name='email_prop'  placeholder='email_prop' class='sub'  required>

<input type='text' name='nom_entreprise'  placeholder='nom_entreprise' class='sub'  required>

<input type='submit' name='submitpro' value='Ajouter+' class='sub add'>
</form></div>";
echo $proinput;
?>
<link rel="stylesheet" href="table.css">
